...
const envUnofficialBase = (process.env.NOTION_UNOFFICIAL_API_BASE || '')
  .trim()
  .replace(/\/$/, '');
const NOTION_UNOFFICIAL_API_BASE =
  envUnofficialBase || 'https://4geeksacademy.notion.site/api/v3';

const notionXV3Auth =
  process.env.NOTION_V3_USE_INTEGRATION_TOKEN === 'true' && process.env.NOTION_TOKEN
